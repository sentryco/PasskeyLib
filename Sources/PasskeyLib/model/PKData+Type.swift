...
extension PKData {
     ...
     *
     * This type alias defines a tuple used to encapsulate various elements needed during the
     * registration of a passkey credential. It is particularly used with Web Authentication (WebAuthn)
     * processes, which is a web standard for secure and passwordless authentication.
     *
     * - Parameters:
     ...
     *
     * Empty credential ID is expected for passkey registrations (identity.credentialID.isEmpty)
     */
    typealias PKRegistration = (
