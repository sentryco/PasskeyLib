...
extension Curve25519.Signing.PrivateKey {
    ...
    /// This initializer decodes a PEM encoded string to extract the raw private key data,
    /// validates it against expected ASN.1 prefix, and then initializes the PrivateKey.
