...
extension Data {
     ...
     */
   internal static func initAttestationObject(aaguid: UUID, relyingParty: String, credentialID: Data, privateKey: P256.Signing.PrivateKey, publicKeySizeInBytes: Int) -> Data {
        var authData = Data()
        ...
        authData.append(contentsOf: [UInt8](credentialID))
        // Encode the public key using CBOR for interoperability.
       let encodedPublicKey = CBOR.cborEncodePublicKey(privateKey.publicKey, publicKeySizeInBytes: publicKeySizeInBytes)
