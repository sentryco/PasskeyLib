...
extension CBOR {
    ...
    /// This method takes a `P256.Signing.PublicKey` and encodes it into a CBOR data structure suitable for cryptographic operations.
    ///
    ...
    /// This method is used to encode authentication data into a CBOR structure for attestation purposes.
    ///
